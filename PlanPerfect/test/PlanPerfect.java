...
public class PlanPerfect {
    public static void main(String[] args) {
        JFrame frame = new JFrame();
        frame.setTitle("Plan Perfect");


        JPanel buttonsPanel = new JPanel();
        JButton dayCalendar = new JButton("Day");
        JButton weekCalendar = new JButton("Week");
        JButton monthCalendar = new JButton("Month");
        JButton yearCalendar = new JButton("Year");

        buttonsPanel.add(dayCalendar);
        buttonsPanel.add(weekCalendar);
        buttonsPanel.add(monthCalendar);
        buttonsPanel.add(yearCalendar);



        dayCalendar.addActionListener(f -> { 
        ...
        weekCalendar.addActionListener(f -> { 
            JFrame frm = new JFrame();
            frm.setTitle("Plan Perfect");
        ...
        monthCalendar.addActionListener(f -> { 

            new MonthCalendar();

        });

        yearCalendar.addActionListener(f -> { 
