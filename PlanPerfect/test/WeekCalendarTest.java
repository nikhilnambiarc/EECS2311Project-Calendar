...
public class WeekCalendarTest {
	public static void main(String[] args) {
		...
		// events.add(new CalendarEvent(LocalDate.of(2023, 03, 8), LocalTime.of(10, 0),
		...
		// events.add(new CalendarEvent(LocalDate.of(2016, 11, 15), LocalTime.of(12, 0),
		// LocalTime.of(13, 20), "Test 15/11 12:00-13:20"));
		// events.add(new CalendarEvent(LocalDate.of(2016, 11, 16), LocalTime.of(9, 0),
		// LocalTime.of(9, 20), "Test 16/11 9:00-9:20"));
		// events.add(new CalendarEvent(LocalDate.of(2016, 11, 17), LocalTime.of(12,
		// 15), LocalTime.of(14, 20), "Test 17/11 12:15-14:20"));
		// events.add(new CalendarEvent(LocalDate.of(2016, 11, 18), LocalTime.of(9, 30),
		...
		// Add a Calendar
		AddWeekCalendar addACalendar = new AddWeekCalendar(events, cal);
