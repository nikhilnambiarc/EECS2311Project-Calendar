...
public class CalendarEvent {
    ...
    private Color color;
    private String goal;
    private String goalProgressFrequency;
    ...
    public String getGoalProgressFrequency() {
        return goalProgressFrequency;
    }

    public void setGoalProgressFrequency(String goalProgressFrequency) {
        this.goalProgressFrequency = goalProgressFrequency;
    }
